...
Todas las pantallas de administración DEBEN (MUST) construirse con un conjunto común de patrones
...
Las pantallas de listado DEBEN (MUST) presentar estados de carga, vacío y error de forma uniforme.
...
Los estados DEBEN (MUST) usar el mapa estado→color del design system: activo/inactivo, tipos de liberación, categorías de puesto, resultado de login y tipo de recurso.
...
Los modales de administración DEBEN (MUST) usar el shell de diálogo común (cabecera, cuerpo, footer)
