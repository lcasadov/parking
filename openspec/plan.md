...
| R4 | `desk-support-admin-flows` | Frontend (funcional) | ⬜ En cola — aprobación adapta a Plaza/Puesto según resourceType, inbox muestra tipo, asignación fija permite puesto | `░░░░░░░░░░` 0% |
| R5 | `floor-plan-real-image` | Frontend (UI) | ⬜ En cola — imagen real de planta + coordenadas reales de los 65 puestos | `░░░░░░░░░░` 0% |
