...
import { TopbarReserve } from './TopbarReserve';
...
export function AppShell({ nav }: AppShellProps) {
  ...
  // CTA "Nueva reserva" del topbar. ADMIN abre el asistente de reserva (crear en
  // nombre de un empleado); EMPLOYEE abre su flujo de solicitud propia; AGENCIA
  ...
  return (
    <div className="app-shell portal-way">
