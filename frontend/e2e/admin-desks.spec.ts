...
// =====================================================================
// Puerta 3 — e2e: edición de puesto (CRUD admin). Los 65 puestos seed ocupan
// todos los números (1-65), así que en vez de crear se edita la categoría de un
// puesto existente (PUT /desks) y se revierte en el propio test.
//
// Nota: el toggle activar/desactivar NO se cubre aquí porque la UI lo cablea al
// endpoint de actualización (que ignora `active`) en vez de al dedicado de
// activación — es un bug de la rama, reportado aparte.
// =====================================================================
