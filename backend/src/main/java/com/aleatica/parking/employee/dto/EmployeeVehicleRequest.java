...
/**
 * Datos de alta/edicion de un vehiculo de empleado (change {@code employee-vehicles}).
 *
 ...
 * unicidad de la matricula por empleado se garantiza en la capa de aplicacion/BD (409). Un unico
 ...
 */
@Schema(description = "Datos de un vehiculo de empleado (solo la matricula es obligatoria)")
public record EmployeeVehicleRequest(
